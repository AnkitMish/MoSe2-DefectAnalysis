...
int makeneighboutlist_peratom(a_coodrinates *input_atoms, int iatom, int Natoms, float *boxmd, float *halfboxmd, float *cellsize, int *ng, float rcutoffsq, long int *llst, long int ***lshd, int **retval){
